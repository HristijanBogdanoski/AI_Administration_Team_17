...
function ChatWidget({ onExpand }) {
  ...
  const [msgs, setMsgs] = useState([
    { type: 'bot', text: 'Здраво! Јас сум АИ Асистентот на БрзиУслуги. Како можам да ви помогнам денес?' }
  ]);
        ...
        <div style={{
          ...
          <div style={{ background: '#1B3A6B', padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ color: '#93c5fd', fontSize: '0.72rem' }}>БрзиУслуги Поддршка</div>
            </div>
            <button
...
const FAQ_DATA = {
  ...
  'Онлајн Услуги': [
    { q: 'Кои услуги се достапни онлајн?', a: 'На порталот БрзиУслуги достапни се над 150 онлајн услуги: поднесување барања за документи, плаќање такси, проверка на статус, закажување термини, пристап до регистри и многу повеќе.' },
    { q: 'Дали треба сметка за БрзиУслуги?', a: 'За повеќето услуги потребна е регистрирана сметка. Регистрацијата е бесплатна и се прави на порталот. Некои информативни услуги се достапни без регистрација.' },
  ],
  Плаќање: [
